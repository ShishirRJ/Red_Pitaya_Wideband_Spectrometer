...
begin
   ...
   axi4lite_accum0_snap_ss_bram_inst: entity work.axi4lite_accum0_snap_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_accum1_snap_ss_bram_inst: entity work.axi4lite_accum1_snap_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_accumdat_snap_ss_bram_inst: entity work.axi4lite_accumdat_snap_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_adc_voltage_snap_ss_bram_inst: entity work.axi4lite_adc_voltage_snap_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_sys_inst: entity work.axi4lite_sys
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
